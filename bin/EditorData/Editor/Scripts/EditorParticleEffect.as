...
void CreateParticleEffectEditor()
{
    ...
    particleEffectWindow = LoadEditorUI("Editor/UI/EditorParticleEffectWindow.xml");
...
void InitParticleEffectPreview()
{
    ...
    gizmo.model = cache.GetResource("Model", "Editor/Models/Axes.mdl");
    gizmo.materials[0] = cache.GetResource("Material", "Editor/Materials/RedUnlit.xml");
    gizmo.materials[1] = cache.GetResource("Material", "Editor/Materials/GreenUnlit.xml");
    gizmo.materials[2] = cache.GetResource("Material", "Editor/Materials/BlueUnlit.xml");
