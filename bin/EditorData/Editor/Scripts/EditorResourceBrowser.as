...
{
    browserWindow = LoadEditorUI("Editor/UI/EditorResourceBrowser.xml");
    ...
    browserFilterWindow = LoadEditorUI("Editor/UI/EditorResourceFilterWindow.xml");
...
void CreateResourcePreview(String path, Node@ previewNode)
{
    ...
    if (resourceType > 0)
    {
        ...
        else if (resourceType == RESOURCE_TYPE_IMAGE)
        {
            ...
            if (image.Load(file))
            {
                ...
                Material@ material =  cache.GetResource("Material", "Editor/Materials/TexturedUnlit.xml");
    ...
    Material@ material =  cache.GetResource("Material", "Editor/Materials/TexturedUnlit.xml");
    Texture2D@ texture = Texture2D();
    Image@ noPreviewImage = cache.GetResource("Image", "Editor/Textures/NoPreviewAvailable.png");
