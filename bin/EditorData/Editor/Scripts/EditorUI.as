...
void CreateUI()
{
    ...
    uiStyle = GetEditorUIXMLFile("Editor/UI/EditorStyle.xml");
    ui.root.defaultStyle = uiStyle;
    iconStyle = GetEditorUIXMLFile("Editor/UI/EditorIcons.xml");

    graphics.windowIcon = cache.GetResource("Image", "Editor/Textures/UrhoIcon.png");
...
void CreateQuickMenu()
{
    ...
    quickMenu = LoadEditorUI("Editor/UI/EditorQuickMenu.xml");
...
{
    contextMenu = LoadEditorUI("Editor/UI/EditorContextMenu.xml");
