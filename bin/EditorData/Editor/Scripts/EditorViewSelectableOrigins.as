...
void CreateOrigin(int index, bool isVisible = false)
{
    ...
    originsIcons[index].texture = cache.GetResource("Texture2D", "Editor/Textures/EditorIcons.png");
    ...
    originsNames[index].SetFont(cache.GetResource("Font", "Editor/Fonts/Roboto.ttf"), NAMES_SIZE);
